...
export function usersReducers(state = {
    ...
    switch(action.type) {
        ...
        case "ADD_USER":
            return {...state, users: [...state.users, ...action.payload], msg: 'Success! Click to continue', style: 'success', validation: 'success'};
        ...
        case "DELETE_USER":
            ...
            return {users: [...currentUserToDelete.slice(0, indexToDelete),
        ...
        case "UPDATE_USER":
            ...
            return {users: [...currentUserToUpdate.slice(0, indexToUpdate), action.payload,
